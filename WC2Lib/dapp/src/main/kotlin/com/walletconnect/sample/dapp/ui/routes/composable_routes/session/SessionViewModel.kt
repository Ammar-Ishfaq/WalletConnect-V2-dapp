...
class SessionViewModel : ViewModel() {
    ...
    init {
        DappDelegate.wcEventModels.filterNotNull().onEach { event ->
            when (event) {
    ...
    fun ping() {
        val pingParams =
            Modal.Params.Ping(topic = requireNotNull(DappDelegate.selectedSessionTopic))
